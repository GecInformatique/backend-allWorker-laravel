...
<head>
    ...
    <title>Potenza Email Template</title>
                                                                ...
                                                                <div class="img" style="font-size:0pt; line-height:0pt; text-align:center">
                                                                    <div class="img-m-center" style="font-size:0pt; line-height:0pt">
                                                                        <a href="#" target="_blank">
                                                                            <img src="http://join-us.all-worker.com/img/logo-light.png" border="0" width="45" height="45" alt="" />
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="fluid-img" style="font-size:0pt; line-height:0pt;">
                                                        <div class="img-center" style="font-size:0pt; line-height:0pt; text-align:center">
                                                            <img src="http://join-us.all-worker.com/img/all-worker.png" border="0" width="357" height="230" alt="" />
                                                        </div>
                                                    </div>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                        <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div style="color:#333333; font-family: 'Work Sans', Arial, sans-serif; font-size:26px; line-height:34px; text-align:center; font-weight: 500;">Bienvenue sur ALL-WORKERS</div>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                        <tr>
                                                            <td height="30" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                                                        </tr>
                                                    ...
                                                    <div style="color:#444444; font-family: 'Work Sans', Arial, sans-serif; font-size:15px; line-height:21px; text-align:left">
                                                        Je suis ravi de vous accueillir M/Mme {{$name}} sur notre plateforme All-Workers,
                                                        l'application dédiée à la valorisation des compétences professionnelles
                                                        pour tous les travailleurs, qu'ils soient indépendants ou salariés.
                                                        Notre mission est de vous offrir un espace où vous pouvez non
                                                        seulement partager vos réalisations et expériences, mais aussi
                                                        découvrir des opportunités pour élargir votre réseau professionnel
                                                        et trouver de nouveaux projets.
                                                    </div>
                                                    <br/>
                                                    <p>Merci de nous avoir rejoins commencez à partager votre parcours
                                                        professionnel avec une communauté qui vous soutient.
                                                    </p>
                                                    <br/>
                                                    <h3>Vos identifiant ALL-WORKERS</h3>
                                                    <br/>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <div class="text-r-m-center" style="color:#777777; font-family: 'Work Sans', Arial, sans-serif; font-size:14px; line-height:24px; text-align:center">
                                                        <a href="https://allwokers.com" target="_blank" style="color:#666666; text-decoration:underline"><span style="color:#666666; text-decoration:underline">www.allwokers.com</span></a>
                                                        <br />
                                                        &copy; 2024 All-Workers - All rights reserved
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
